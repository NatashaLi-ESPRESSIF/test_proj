...
ESP32-PICO-KIT V4 是一款来自`乐鑫<https://espressif.com>`_的开发板，其核心采用了具有完整 Wi-Fi 和蓝牙功能的 ESP32 系列 SIP 模组 ESP32-PICO-D4。与其他 ESP32 系列模组相比，ESP32-PICO-D4 模组已将 40 MHz 晶体振荡器、4 MB flash、滤波电容及射频匹配链路等所有外围器件无缝集成进封装内，无需外围元器件即可工作。这将大大降低了用户额外采购元器件的数量和成本，及额外组装测试的复杂度。
...
5V LED 电源指示灯
    当开发板通电后（USB 或外部 5V），该指示灯将亮起。更多信息，请见 `相关文档`_中的原理图。
...
下表介绍了开发板 I/O 管脚的 **名称** 和 **功能**，具体布局请见`相关文档`_中的原理图。请参考 :ref:`get-started-pico-kit-v4-board-front`。
